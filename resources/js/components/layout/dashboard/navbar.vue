                                ...
                                <div aria-labelledby="user-menu" aria-orientation="vertical" class="py-1 rounded-md bg-white shadow-xs" role="menu">
                                    <div class="flex items-center px-4 ce py-2 border-b border-gray-100">
                                        ...
                                        <div class="w-40">
                                            ...
                                            <div class="text-xs truncate text-gray-500 font-weight-bold"
                                                 v-if="$store.state.user.role"
                                                 >( {{ $store.state.user.role.name }} )</div>
                                            <div class="text-xs truncate text-gray-500">{{ $store.state.user.email }}
                                            </div>
                                        </div>
                                    </div>
                                    <router-link
