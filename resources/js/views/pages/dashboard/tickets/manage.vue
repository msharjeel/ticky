                ...
                <div class="w-full h:auto sm:h-14 border-b sm:px-3">
                    <div class="sm:flex sm:justify-between">
                        <div class="flex">
                            ...
                            <!-- Back button, don't show it right now -->
                            <!-- 
                            <button class="btn p-4 rounded-none" type="button" @click="$router.push('/dashboard/tickets-my')">
                            ...
                            <template>
                                <div v-on-clickaway="closeActionDropdown" class="block">
                                    ...
                                    <div v-if="userHasPermission_FromMixin('CAN_UPDATE_TICKET_USER')" class="relative inline-block text-left">
                                        <button class="btn p-4 rounded-none" title="Agent Selector" type="button" @click="toggleActionDropdown('agent')">
                                    ...
                                    </div><!-- Agent Selector - end -->


                                    <!-- Organization Selector - start -->
                                    <div v-if="userHasPermission_FromMixin('CAN_UPDATE_TICKET_DEPARTMENT')" class="relative inline-block text-left">
                                        <button class="btn p-4 rounded-none" type="button" @click="toggleActionDropdown('department')" title="Organization Selector">
                                    ...
                                    </div><!-- Organization Selector - end -->

                                    <!-- Label Selector - start -->
                                    <div v-if="userHasPermission_FromMixin('CAN_UPDATE_TICKET_LABEL')" class="relative inline-block text-left">
                                        <button class="btn p-4 rounded-none" title="Label Selector" type="button" @click="toggleActionDropdown('label')">
                                    ...
                                    </div><!-- Label Selector - end -->

                                    <!-- Priority Selector - start -->
                                    <div v-if="userHasPermission_FromMixin('CAN_UPDATE_TICKET_PRIORITY')" class="relative inline-block text-left" style="display: none;" data-buttonparent="priority" data-view="manage">
                                        <button class="btn p-4 rounded-none" title="Priority Selector" type="button" @click="toggleActionDropdown('priority')">
                                    ...
                                    </div><!-- Priority Selector - end -->
                                </div>

                                <button 
                                    v-if="userHasPermission_FromMixin('CAN_DELETE_TICKET')"
                                    class="btn p-4 rounded-none" title="Delete Fault" type="button" @click="deleteTicketModal = true">
                        ...
                        <div class="sm:flex sm:items-center py-3 max-w-full border-b">
                            ...
                            <div class="px-6 sm:pl-3 sm:pr-6 sm:flex-1 sm:w-1/4">
                                <div class="flex items-center sm:float-right mt-3 sm:mt-0">
                                    ...
                                    <button 
                                        v-if="userHasPermission_FromMixin('CAN_REPLY_ON_TICKET')"
                                    ...
                                    <template v-slot:bottom>
                                        <div class="flex justify-between border border-t-0">
                                            <button
                                                ...
                                                type="button"
                                                @click="discardReply"
                                                v-if="userRole_FromMixin('Admin') || true"
                                            >
                                                {{ $t('Discard') }}
                                            </button>
                                            <div class="flex">
                                                <select
                                                    v-if="userHasPermission_FromMixin('CAN_UPDATE_TICKET_STATUS')"
                                                    id="status"
                                                ...
                                                >
                                                    <template v-for="status in allowedStatusList">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm leading-5 text-gray-500">
                                            {{ $t('Are you sure you want to delete the fault?') }}
