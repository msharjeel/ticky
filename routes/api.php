...
use App\Http\Controllers\Api\Dashboard\Admin\DepartmentLocationsController as DashboardAdminDepartmentLocationsController;
use App\Http\Controllers\Api\Dashboard\Admin\LabelController as DashboardAdminLabelController;

use App\Http\Controllers\Api\Dashboard\Admin\TicketTypeController as DashboardAdminTicketTypeController;
...
use App\Http\Controllers\Api\Dashboard\Admin\PreventiveMaintenanceController;


Route::get('tickets/reports-kpi', [ReportController::class, 'ticketsReportKPI'])->name('dashboard.tickets.reports');
Route::get('tickets/reports', [ReportController::class, 'ticketsReports'])->name('dashboard.tickets.reports');
Route::get('tickets/report-summary', [ReportController::class, 'ticketsReportSummary'])->name('dashboard.tickets.report_summary');
...
Route::group(['prefix' => 'account'], static function () {
    ...
    Route::post('updateFlagForPasswordChange', [AccountAccountController::class, 'updateFlagForPasswordChange']);
...
Route::get('tickets/filters',     [UserTicketController::class, 'filters'])->name('tickets.filters');
...
Route::group(['prefix' => 'dashboard'], static function () {
    ...
    Route::get('preventive-maintenance/fetch', [PreventiveMaintenanceController::class, 'preventive_maintenance_fetch'])->name('preventive-maintenance.fetch');

    Route::post('preventive-maintenance/save', [PreventiveMaintenanceController::class, 'preventive_maintenance_save'])->name('preventive-maintenance.save');
    ...
    Route::group(['prefix' => 'admin'], static function () {
        ...
        Route::apiResource('department_locations', DashboardAdminDepartmentLocationsController::class);
        
        Route::post('department_locations_delete', [DashboardAdminDepartmentLocationsController::class, 'departmentLocationsDelete'])->name('department.locations.delete');

        Route::get('category/listing', [DashboardAdminDepartmentLocationsController::class, 'categoryListing'])->name('categoryListing');
        ...
        Route::get('sub-departments-of/{parent_id}', [DashboardAdminDepartmentController::class, 'subDepartmentsOf'])->name('dashboard.sub-departments-of');


        Route::apiResource('labels', DashboardAdminLabelController::class);

        Route::apiResource('ticket_types', DashboardAdminTicketTypeController::class);
        Route::post('ticket_types/addEdit', [DashboardAdminTicketTypeController::class, 'addEdit'])->name('ticket_types.addEdit');
