...
class UserRoleController extends Controller
{
     ...
     * @return JsonResponse
     * @throws Exception
     * url: https://ticky1.weareone-bh.org/api/dashboard/admin/user-roles/permissions
     */
    public function permissions(): JsonResponse
    {
        ...
        //if you want to add new permission, add in file(app.extra_permissions)
        //CAN_VIEW_REPORT
        $extra_permissions = config('app.extra_permissions');
        foreach($extra_permissions as $key){
            $permissionsKeys[] = $key;
