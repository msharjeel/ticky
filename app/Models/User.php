...
class User extends Authenticatable
{
    ...
    //department details of user
    public function department()
    {
        return $this->hasOne(Department::class, 'id', 'department_id');
    }

    //rufi created relation b/w user and department, will work a/c to user table department_id field
    public function departmentOfUser(): BelongsTo
    {
    ...
    public function roleName(){
        $roleName = "";
        if( !empty( optional($this->userRole)->name) ){
            $roleName = optional($this->userRole)->name;
        }
        return $roleName;
    }
}
